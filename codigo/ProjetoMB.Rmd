...
model.sem_priors <- bcfa(model.sem_priors, data=df, std.lv=TRUE, n.chains = n_chains,
                 burnin=burn_in, sample=sample_estimate, target = "stan", dp = dp)
```


```{r}
summary(model.sem_priors, standardized=TRUE, rsquare=TRUE)
```
